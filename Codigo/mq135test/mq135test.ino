...
#define         MQ135PIN                       (A3)     //define which analog input channel you are going to use
...
void loop() {
   ...
   dados["CO2"] = MQGetGasPercentage(MQRead(MQ135PIN)/Ro,GAS_CARBON_DIOXIDE);
   dados["CO"] = MQGetGasPercentage(MQRead(MQ135PIN)/Ro,GAS_CARBON_MONOXIDE); 
   dados["Alcool"] = MQGetGasPercentage(MQRead(MQ135PIN)/Ro,GAS_ALCOHOL); 
   dados["NH3"] = MQGetGasPercentage(MQRead(MQ135PIN)/Ro,GAS_AMMONIUM);
   dados["C7H8"] = MQGetGasPercentage(MQRead(MQ135PIN)/Ro,GAS_TOLUENE);
   dados["C3H60"] = MQGetGasPercentage(MQRead(MQ135PIN)/Ro,GAS_ACETONE);
